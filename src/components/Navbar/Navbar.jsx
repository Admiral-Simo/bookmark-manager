...
const Navbar = () => {
  return (
    <nav className="container py-16 px-3 mx-auto">
      <div className="flex items-center  justify-between">
        ...
        <div className="hidden md:flex space-x-10 items-center uppercase">
          <p className="text-gray-400 cursor-pointer tracking-widest transition-colors duration-300 hover:text-red-400">
            features
          </p>
          <p className="text-gray-400 cursor-pointer tracking-widest transition-colors duration-300 hover:text-red-400">
            download
          ...
          <button className="py-2 opacity-90 uppercase px-9 border-2 border-red-500 rounded-lg bg-red-500 text-white hover:bg-white hover:text-red-500 transition-colors duration-300">
            Login
          </button>
        </div>
      </div>
